# PROJECT:  badboys  
# PURPOSE:  review TZA targets (based on ZAM review)
...
# Country: Tanzania
# Target Setting Tool Last Loaded: 2024-04-04 08:28:40 AM
# Target Summary: Total Population and KP

# GLOBAL VARIABLES --------------------------------------------------------
  
  ref_id <- "cdd4a3a7"  #a reference to be places in viz captions 
  
  path_paw <- c("Data/COP23_FY25 & ROP24_FY25-26 Target Setting Tool Dossier_TZA.csv",
                "Data/COP23_FY25 & ROP24_FY25-26 Target Setting Tool Dossier_TZA_KP.csv")
